...
Same live data (status, market scanner, trade log) rendered in the browser instead of the terminal — handy for viewing the pipeline remotely or on a second screen.

```bash
python cli.py web
# open http://127.0.0.1:8000

# custom host/port and scan interval
python cli.py web --host 0.0.0.0 --port 9000 --speed 30
```
