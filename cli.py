...
Usage:
    ...
    python cli.py web                  # Launch browser-based dashboard
...
def cmd_web(args):
    """Launch the browser-based dashboard (Flask)."""
    from webapp import run_web
    console.print(f"[bright_green]Web dashboard running at http://{args.host}:{args.port}[/bright_green]")
...
def main():
    ...
    # web
    p_web = sub.add_parser("web", help="Launch browser-based dashboard")
    p_web.add_argument("--speed", type=float, default=60.0, help="Seconds between scan cycles")
